...
#define SUPER_SECRET_PASSWORD_SETTINGS  PROCESS(super_secret, SUPER_SECRET_PASSWORD_KEY, qsUploaderSecretPassword)
#define PROMPT_BEFORE_SENDING_IMAGE_SETTINGS  PROCESS(pooping, PROMPT_BEFORE_SENDING_IMAGE_KEY, bPromptBeforeSendingImage)
...
#define PROCESS_ALL_SETTINGS   \
	...
	SUPER_SECRET_PASSWORD_SETTINGS \
	PROMPT_BEFORE_SENDING_IMAGE_SETTINGS \
